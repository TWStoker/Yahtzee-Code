...
public class YahtzeeSinglePlayer {
    ...
    static int[][] whatCanBeScored(int[][] currentScoreRecord, int[] theDice) {
		//Scoring Y FH LS SS 4K 3K On Tw Th Fo Fi Si C
...
//	        	System.out.println("It's 3K");
	...
	static int[][] chooseWhatToScore(int[][] currentScoreRecord, int [][]canScoreThisRound){
		//Scoring Y FH LS SS 4K 3K On Tw Th Fo Fi Si C
